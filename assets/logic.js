...
function ticketmaster() {
  ...
  $.ajax({
    type: "GET",
    url:
      "https://app.ticketmaster.com/discovery/v2/events.json?apikey=FHlXGGy5pkbqcfKrq9TAErHgeV0EHiMb&city=" +
      text +
    ...
    success: function (json) {
      ...
      if (!json._embedded) {
        $(".searchResults").append(
          "<div class='eventInfo card-panel small center-align'>" +
            "There are no events in this city. <br> Please enter another city." +
            "</div>"
        );
      } else {
        ...
        if (text == "") {
            ...
            if (!eventName[i].priceRanges) {
              $(".searchResults").append(
                "<div class='eventInfo card-panel small center-align'>" +
                  ...
                  "</li>" +
                  "<li class='price'>" +
                  "There are no avaliable ticket prices" +
                  "</li>" +
                  "<li class = 'artistInfoResults" +
                  [i] +
                  "'> <li>" +
                  "<a class='btn-floating btn-large pulse lime lighten-2' href=" +
                  searchUrl +
                  " target = _blank>" +
                  "Buy" +
                  "</a>" +
          ...
          let LastFM0 =
            ...
            band[0] +
            "&api_key=78661b1408a61c6f77a83efc09f78da4&format=json";
          fetch(LastFM0)
